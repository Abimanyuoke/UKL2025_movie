...
export const getAllTransaksi = async (_req: any, res: { json: (arg0: { success?: boolean; data?: { borrow_date: string; return_date: string; transaksiId: number; userId: number | null; movieId: number | null; qty: number; createdAt: Date; updatedAt: Date; }[]; msg?: unknown; }) => void; }) => {
  try {
...
export const getTransaksiById = async (req: { params: { id: any; }; }, res: { json: (arg0: { success: boolean; data: any; }) => void; status: (arg0: number) => { (): any; new(): any; json: { (arg0: { success?: boolean; message?: string; msg?: unknown; }): void; new(): any; }; }; }) => {
  try {
